...
/**
  ...
  * @param  GPIOx：对于STM32F405xx/407xx和STM32F415xx/417xx器件，x可以为（A..K），用于选择GPIO外设；
  *                      对于STM32F42xxx/43xxx器件，x可以为（A..I），用于选择GPIO外设；
  *                      对于STM32F401xx器件，x可以为（A、B、C、D和H），用于选择GPIO外设。
  * @param  GPIO_InitStruct：指向GPIO_InitTypeDef结构体的指针，该结构体包含
  *         指定GPIO外设的配置信息。
  * @retval 无
  */
...
/**
  * @brief  切换指定的GPIO引脚。
  * @param  GPIOx：对于STM32F405xx/407xx和STM32F415xx/417xx设备，x可以是（A..K）以选择GPIO外设
  *                      对于STM32F42xxx/43xxx设备，x可以是（A..I）以选择GPIO外设。
  *                      对于STM32F401xx设备，x可以是（A、B、C、D和H）以选择GPIO外设。
...
/**
  ...
  * @brief  更改指定引脚的映射。
  * @param  GPIOx：对于STM32F405xx/407xx和STM32F415xx/417xx器件，x可以为（A..K）以选择GPIO外设；
  *                      对于STM32F42xxx/43xxx器件，x可以为（A..I）以选择GPIO外设；
  *                      对于STM32F401xx器件，x可以为（A、B、C、D和H）以选择GPIO外设。
  * @param  GPIO_PinSource：指定用于复用功能的引脚。
  *         此参数可以是GPIO_PinSourcex，其中x可以为（0..15）。
  * @param  GPIO_AFSelection：选择用作复用功能的引脚。
  *          此参数可以是以下值之一：
